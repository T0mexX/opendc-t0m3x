...
//
//internal class RoutTbl3(private val owner: Node<*>) : RWLock(
//    readPermits = owner.nPorts.takeIf { it != 0 } ?: 10
//), MutableMap<IPv4Address, RoutTbl3.Entry> by mutableMapOf() {
//    /**
//     * TODO
...
//        return this[destAddr]?.values ?: emptyList()
//    }
//
//    /**
//     * TODO
...
//            // highlight this as the shortest path to `n` (since distance 1)
//            ).also { e.shortestPath = it }
//        }
//
//        return true
//    }
//
//    context(NetSimScope)
//    internal suspend fun updtWithInfoFrom(t: RoutTbl3): Boolean {
//        assert(t.owner != owner)
//        assert(t.owner.ip != owner.ip)
//
...
//        if (this[b]?.get(t.owner.ip)?.distance != 1) {
//            changed = changed or registerAdjN(t.owner, b)
//        }
//
...
//
//    /**
//     * Called already with locks.
//     */
//    private suspend fun updtWithInfoFrom(e: RoutTbl3.Entry, updts: MutableMap<IPv4Address, >): Boolean {
//
//    }
//
////
...
//        lateinit var shortestPath: RoutTblPath
//    }
//
//    /**
//     * @property destAddr Can be both a subnet or a specific ip.
